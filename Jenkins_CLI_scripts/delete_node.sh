...
echo "Please enter the node name  which node need to Delete...!"
echo "------------------------------------------"
read NodeName
...
echo "Deleting the Jenkins node...!"
echo "--------------------------------"
java -jar jenkins-cli.jar -auth $JenkinsUsername:$JenkinsToken -s $JenkinsUrl  delete-node $NodeNameName